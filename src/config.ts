...
const envSchema = z.object({
  ...
  DEFAULT_WHITELIST: z.string().default('registry.npmjs.org,github.com,raw.githubusercontent.com,api.anthropic.com,platform.claude.com,downloads.claude.ai,cloud.langfuse.com,*.datadoghq.com,slack.com,x.com'),
